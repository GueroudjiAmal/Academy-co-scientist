...
class VectorStoreAgent(Agent):
    ...
    def __init__(
        ...
        preload_metas: list[dict[str, Any]] | None = None,
        preload_embs: list[list[float]] | None = None,
    ) -> None:
        super().__init__()
        ...
        self._embs: list[list[float]] | None = preload_embs
    ...
    async def query(
        ...
        for score, idx in zip(sims, idxs, strict=False):
            if idx < 0:
                continue
